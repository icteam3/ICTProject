...
class MediauploadField extends FormField{
	...
	public function setView() {
		...
		$this->_value .= '<div class="form_holder"><input class="upload_media" type="text" id="'.$this->_id.'" name="'.$this->_name.'" '.(($required) ? ' required ' :  '' ).'  value="'.(is_array(get_option($this->_name)) ? implode(get_option($this->_name)) : get_option($this->_name) ).'" />';
