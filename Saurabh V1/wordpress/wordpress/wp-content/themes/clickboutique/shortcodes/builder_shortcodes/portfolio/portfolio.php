...
if ( ! class_exists( 'IG_Portfolio' ) ) {
	...
	class IG_Portfolio extends IG_Pb_Shortcode_Parent {
		...
		public function element_config() {
			...
			$this->config['shortcode'] = strtolower( __CLASS__ );
			$this->config['name']      = __( 'Portfolio Item',  'plumtree' );
			$this->config['cat']       = __( 'Typography',  'plumtree' );
			$this->config['icon']      = 'icon-paragraph-text';
			$this->config['exception'] = array(
				'default_content'  => __( 'Portfolio Item',  'plumtree' ),
				'require_js'       => array( ),
				'data-modal-title' => __( 'Portfolio Item',  'plumtree' )
			);
