...
function register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            'name'     				=> 'Cloud Zoom for WooCommerce', // The plugin name
            'slug'     				=> 'cloud-zoom-for-woocommerce', // The plugin slug (typically the folder name)
            'source'   				=> get_stylesheet_directory() . '/required-plugins/cloud-zoom-for-woocommerce.zip', // The plugin source !!!! Important
            'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
            'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            'name'     				=> 'Rotating Tweets', // The plugin name
            'slug'     				=> 'rotatingtweets', // The plugin slug (typically the folder name)
            'source'   				=> get_stylesheet_directory() . '/required-plugins/rotatingtweets.zip', // The plugin source !!!! Important
            'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
            'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            ...
            'slug'     				=> 'simple-social-share-icons', // The plugin slug (typically the folder name)
            'source'   				=> get_stylesheet_directory() . '/required-plugins/simple-social-share-icons.zip', // The plugin source !!!! Important
            'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
            'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            ...
            'slug'     				=> 'twiget.zip', // The plugin slug (typically the folder name)
        ...
        array(
            'name'     				=> 'WP Recent Comments with Avatars', // The plugin name
            'slug'     				=> 'wp-recent-comments-with-avatars', // The plugin slug (typically the folder name)
            'source'   				=> get_stylesheet_directory() . '/required-plugins/wp-recent-comments-with-avatars.zip', // The plugin source !!!! Important
            'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
            'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
        ...
        array(
            'name'     				=> 'WooCommerce Quick View', // The plugin name
            'slug'     				=> 'jck_woo_quickview', // The plugin slug (typically the folder name)
            'source'   				=> get_stylesheet_directory() . '/required-plugins/jck_woo_quickview.zip', // The plugin source !!!! Important
            'required' 				=> true, // If false, the plugin is only 'recommended' instead of required
            'version' 				=> '', // E.g. 1.0.0. If set, the active plugin must be this version or higher, otherwise a notice is presented
            'force_activation' 		=> false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch
            'force_deactivation' 	=> false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins
    ...
    ); //To add additinal plugins use the same arrows within an arrow

    // Change this to your theme text domain, used for internationalising strings
   

    $config = array(
        'domain'       		=> 'plumtree',         	// Text domain - likely want to be the same as your theme.
        ...
        'strings'      		=> array(
            ...
            'installing'                       			=> __( 'Installing Plugin: %s', 'plumtree' ), // %1$s = plugin name
            ...
            'complete' 									=> __( 'All plugins installed and activated successfully. %s', 'plumtree' ), // %1$s = dashboard link
