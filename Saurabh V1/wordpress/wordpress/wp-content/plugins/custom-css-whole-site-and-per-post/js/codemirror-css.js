...
var config;
    ...
    CodeMirror.fromTextArea(document.getElementById('h5ab-custom-external'), config).setSize('auto', 100);
    CodeMirror.fromTextArea(document.getElementById('h5ab-custom-styling'), config).setSize('auto', 300);
