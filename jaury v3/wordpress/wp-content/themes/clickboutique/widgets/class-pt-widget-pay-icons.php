			...
			<ul class="pt-widget-pay-icons">
				<?php if( $americanexpress ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/americanexpress-icon.png" title="<?php _e('American Express', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $discover ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/discover-icon.png" title="<?php _e('Discover', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $maestro ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/maestro-icon.png" title="<?php _e('Maestro', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $mastercard ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/mastercard-icon.png" title="<?php _e('MasterCard', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $paypal ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/paypal-icon.png" title="<?php _e('PayPal', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $visa ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/visa-icon.png" title="<?php _e('Visa', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $westernunion ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/westernunion-icon.png" title="<?php _e('Western Union', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $giftcards ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/giftcards-icon.png" title="<?php _e('Gift Cards', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
				<?php if( $cash ) : ?>
					<li class="option-title">
						<img src="<?php echo get_template_directory_uri(); ?>/img/theme_img/pay-icons/cash-icon.png" title="<?php _e('Cash', 'plumtree'); ?>"  />
					</li>
				<?php endif; ?>
