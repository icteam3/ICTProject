	...
	class IG_Item_Progressbar extends IG_Pb_Shortcode_Child {
		...
		public function element_shortcode_full( $atts = null, $content = null ) {
			...
			if ( $pbar_group == 'stacked' ) {
				...
				$html_sub_elm .= "<div class='progress-bar {$pbar_color}' role='progressbar'{$pbar_value}aria-valuemin='0' aria-valuemax='100'></div>";
				$html_sub_elm .= "<span class='sr-only'>{$percent}</span>";
				$html_sub_elm .= '</div>';
			}
